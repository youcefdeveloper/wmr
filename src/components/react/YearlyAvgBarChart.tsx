...
import type { YeahlyAvgRates } from '@api-v1-types/common'
import { Chart } from 'react-google-charts'
import { useMortgageCalculatorStore } from '@stores/mortgage.calculator.store'

type YearlyAvgBarChartProps = {
...
function YearlyAvgBarChart({
  rates,
  theme,
  firstYear,
  lastYear,
}: YearlyAvgBarChartProps) {
...
export default YearlyAvgBarChart
