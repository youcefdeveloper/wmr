...
type USVisitColumnChartProps = {
    data: USVisitType
}

export default function USVisitColumnChart({ data }: USVisitColumnChartProps) {
  ...
  return (
    <div className="chart-scroll-wrapper-lg" style={{ width: '100%' }}>
      <div className="chart-scroll-lg chart-column" style={{ width: '100%' }}>
        <Chart 
